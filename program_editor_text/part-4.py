...
class Main(QtWidgets.QMainWindow):
    ...
    def initToolbar(self):
        #self.newAction1 = QtGui.QAction(QtGui.QIcon("icons/1.jpg"), "",self)
        #self.newAction=QtGui.self.start()
  #      self.toolbar1 = self.addToolBar("Principal")
 #       self.toolbar1.setIconSize(QtCore.QSize(400,210))
#        self.toolbar1.setToolButtonStyle(QtCore.Qt.ToolButtonTextUnderIcon)
#        self.newAction.triggered.connect(self.new)

    
       #  self.toolbar1.addAction(self.newAction1)
       #  #self.toolbar1.addAction(self.newAction)
       #  self.addToolBarBreak()
       # # self.pauseButton.setIconSize(QtCore.QSize(30, 30))
       #  os.environ['SDL_VIDEO_WINDOW_POS'] = "%d,%d" % (300,420)
       #  #pygame.init()
       #  self.start(self)
       #  screen = pygame.display.set_mode((565, 437), pygame.NOFRAME)

        maxi = QtWidgets.QAction(QtGui.QIcon("icons/1.png"),"My name is Maxi",self)
        ...
        self.toolbar1.addAction(maxi)
      #   self.maxi.setIconSize(QtCore.QSize(128, 128)) # <---
    ...
    def initUI(self):
        ...
        self.setWindowTitle("Predictor betha")
